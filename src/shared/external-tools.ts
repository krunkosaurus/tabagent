...
export const EXTERNAL_TOOLS = [
  ...
  { name: "click", description: "Click an element using its exact snapshot ref. Requires approval in TabAgent.", readonly: false,
    parameters: object({ ref, button: { type: "string", enum: ["left", "right", "middle"] }, doubleClick: bool }, ["ref"]) },
  { name: "type", description: "Type into an input using its snapshot ref. Requires approval; submit can send a form.", readonly: false,
    parameters: object({ ref, text, clearFirst: bool, submit: bool }, ["ref", "text"]) },
  { name: "navigate", description: "Navigate the shared tab to an HTTP(S) URL. Always requires explicit approval.", readonly: false,
    parameters: object({ url: { type: "string", maxLength: 4096 } }, ["url"]) },
  { name: "scroll", description: "Scroll the shared tab. Requires approval in TabAgent.", readonly: false,
    parameters: object({ direction: { type: "string", enum: ["up", "down", "left", "right"] }, amount: number(0, 100_000) }) },
  { name: "scroll_to", description: "Scroll a snapshot ref into view. Requires approval in TabAgent.", readonly: false, parameters: object({ ref }, ["ref"]) },
  { name: "hover", description: "Hover over an element using its snapshot ref. Requires approval in TabAgent.", readonly: false, parameters: object({ ref }, ["ref"]) },
  { name: "press_key", description: "Press a key or key combination. Requires approval; Enter can submit a form.", readonly: false,
  ...
  { name: "set_text", description: "Replace an element's visible text using its snapshot ref (for example, translation). Requires approval.", readonly: false,
